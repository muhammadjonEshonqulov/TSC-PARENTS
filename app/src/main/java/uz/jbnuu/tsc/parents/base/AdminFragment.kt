...
import uz.jbnuu.tsc.parents.databinding.AdminFragmentBinding
import uz.jbnuu.tsc.parents.model.student.NotificationsData
import uz.jbnuu.tsc.parents.model.student.PushNotification
import uz.jbnuu.tsc.parents.utils.Constants
import uz.jbnuu.tsc.parents.utils.NetworkResult
import uz.jbnuu.tsc.parents.utils.collectLatestLA
import uz.jbnuu.tsc.parents.utils.snackBar
...
class AdminFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.send.setOnClickListener {
            sendNotification(Constants.full_url, PushNotification(NotificationsData(99, "My tittle", "My own text", "My own sub text"), Constants.topic))
        }
    }
