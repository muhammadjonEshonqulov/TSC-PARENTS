...
import uz.jbnuu.tsc.parents.databinding.ItemDeadlineBinding
import uz.jbnuu.tsc.parents.model.subjects.FilterData
...
//            var downloadId = downloadRequest.start(this)
            ...
            if (bindingAdapterPosition % 2 == 1) {
                binding.itemBack.setBackgroundColor(ContextCompat.getColor(binding.root.context, uz.jbnuu.tsc.parents.R.color.items_color_0))
            } else {
